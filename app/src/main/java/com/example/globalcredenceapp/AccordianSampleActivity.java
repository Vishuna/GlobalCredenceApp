...
public class AccordianSampleActivity extends ListActivity implements OnClickListener
{
    ...
    private void hideThemAll()
    {
        ...
        if(openLayout == panel2)
            panel2.startAnimation(new ScaleAnimToHide(1.0f, 1.0f, 1.0f, 0.0f, 200, panel2, true));
        if(openLayout == panel3)
            panel3.startAnimation(new ScaleAnimToHide(1.0f, 1.0f, 1.0f, 0.0f, 200, panel3, true));
        if(openLayout == panel4)
            panel4.startAnimation(new ScaleAnimToHide(1.0f, 1.0f, 1.0f, 0.0f, 200, panel4, true));
        if(openLayout == panel5)
            panel5.startAnimation(new ScaleAnimToHide(1.0f, 1.0f, 1.0f, 0.0f, 200, panel5, true));
    }
    ...
    {
        {
            ...
            if(layoutView.getId() == R.id.text1)
            {
                ...
                if(v != View.VISIBLE)
                {
                    panel1.startAnimation(new ScaleAnimToShow(1.0f, 1.0f, 1.0f, 0.0f, 200, panel1, true));
                }
            }
            else if(layoutView.getId() == R.id.text2)
            {
                ...
                if(v != View.VISIBLE)
                {
                    panel2.startAnimation(new ScaleAnimToShow(1.0f, 1.0f, 1.0f, 0.0f, 200, panel2, true));
                }
            }
            else if(layoutView.getId() == R.id.text3)
            {
                ...
                if(v != View.VISIBLE)
                {
                    panel3.startAnimation(new ScaleAnimToShow(1.0f, 1.0f, 1.0f, 0.0f, 200, panel3, true));
                }
            }
            else if(layoutView.getId() == R.id.text4)
            {
                ...
                if(v != View.VISIBLE)
                {
                    panel4.startAnimation(new ScaleAnimToShow(1.0f, 1.0f, 1.0f, 0.0f, 200, panel4, true));
                }
            }
            else if(layoutView.getId() == R.id.text5)
            {
                ...
                if(v != View.VISIBLE)
                {
                    panel5.startAnimation(new ScaleAnimToShow(1.0f, 1.0f, 1.0f, 0.0f, 200, panel5, true));
                }
            }
        }
    }
